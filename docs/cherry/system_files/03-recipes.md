# 🍳 Sub-Agent 03: Recipes & Ingredients (The 11-Dish Symphony)

**Source File:** `packages/front/src/prompts/subagents/03-recipes.ts`  
**Internal Variable:** `AGENT_RECIPES`
...
2. THE AKHA TRINITY (Authentic tribal dishes)
...
⚠️ INGREDIENT GUARDRAIL:
We use fresh highland ingredients: Galangal, Kaffir Lime Leaf, Lemongrass, Palm Sugar, and more. 
If a user asks for deep botanical descriptions of specific ingredients (e.g., "What is Fingerroot?" or "Tell me about Sichuan Pepper"), DO NOT HALLUCINATE. Inform them that we use over 50 fresh ingredients from the local market, and use your Database Lookup tool to fetch the exact data from our 'ingredients_library'.
```

---

## 🛠 Usage in System
This file provides the structural menu knowledge and culinary secrets that make Cherry sound like an expert chef. It also defines the 11-dish core rule.
