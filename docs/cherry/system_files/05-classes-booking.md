# 📅 Sub-Agent 05: Classes, Logistics & Booking (Commercial RAG)

**Source File:** `packages/front/src/prompts/subagents/05-classes-booking.ts`  
**Internal Variable:** `AGENT_CLASSES_BOOKING`
...
## 🛠 Usage in System
This sub-agent manages the commercial flow. It explicitly delegates complex lookups (specific hotel zones and seat availability) to the Database Lookup tool to avoid errors.
