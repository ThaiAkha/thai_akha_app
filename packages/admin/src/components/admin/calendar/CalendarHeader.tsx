      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className={cn(
            ...
            canNavigatePrev
              ? 'bg-white dark:bg-gray-900 border-gray-100 dark:border-gray-800 hover:border-brand-200 dark:hover:border-brand-500/30 text-gray-800 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100'
        ...
        <button
          onClick={onNext}
          className="p-2 rounded-xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 hover:border-brand-200 dark:hover:border-brand-500/30 transition-all active:scale-95 text-gray-800 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100"
        >
