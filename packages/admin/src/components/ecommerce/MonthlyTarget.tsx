    ...
    <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]">
      <div className="px-5 pt-5 bg-white rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6">
        ...
        <div className="relative ">
          ...
          <span className="absolute left-1/2 top-full -translate-x-1/2 -translate-y-[95%] rounded-full bg-sys-success/10 px-3 py-1 text-xs font-medium text-success dark:bg-sys-success/15 dark:text-success">
            +10%
          </span>
        </div>
