...
/**
 * 🌍 Pannello bandierine (desktop) — vedi LanguageSwitcher.tsx per il quadro
 * d'insieme delle due forme.
 *
 * Vive in un file suo perche' e' l'unico pezzo della SIDEBAR che usa
 * framer-motion: importato dalla shell teneva 126 KB di libreria (41 compressi)
 * nel chunk d'ingresso di OGNI pagina, per un pannello che a interruttore i18n
 * spento non compare mai. Sidebar lo carica con `lazy` e solo quando le lingue
 * sono piu' di una (2026-09-05).
 */
...
export default LanguageFlagPanel;
