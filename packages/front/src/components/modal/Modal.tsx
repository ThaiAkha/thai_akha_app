        ...
        {(title || !hideCloseButton) && (
          <div className={cn(
            ...
            {!hideCloseButton && (
              <button 
                onClick={onClose}
                className="size-10 pointer-coarse:size-11 rounded-full bg-white/5 hover:bg-white/10 flex items-center justify-center transition-colors text-sub hover:text-primary active:scale-90"
              >
