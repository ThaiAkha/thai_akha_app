...
const Avatar: React.FC<AvatarProps> = ({
  ...
  const renderContent = () => {
    ...
    return (
      <div className="w-full h-full flex items-center justify-center bg-white/5 text-muted/40">
  ...
  return (
    ...
    >
      ...
      <div className="hidden fallback-active:flex absolute inset-0 items-center justify-center bg-white/5 text-muted/40">
