/**
 * StyleColorsTab — Color & Token reference (tab "colors" dello Style Guide)
 * Sorgente di verità: base-theme.css + theme.css + tokens.css
 * Migrato da ZZColorsPage (fuso nello Style Guide). Light & Dark via token semantici.
 */
...
const COLOR_GROUPS: ColorGroup[] = [
  ...
  {
    id: 'ocean', name: 'Ocean · FAQ / Info world',
    sub: 'bg-deep-ocean … bg-pale-ice  ·  famiglia condivisa con Cherry AI  ·  btn-s → ocean-blue',
    anchor: '#0396c7',
    colors: [
      { label: 'deep-ocean', hex: '#01356d', tw: 'bg-deep-ocean', note: 'safe text on white' },
      { label: 'deep-blue',  hex: '#016ca5', tw: 'bg-deep-blue',  note: 'safe text on white' },
      { label: 'ocean-blue', hex: '#0396c7', tw: 'bg-ocean-blue', anchor: true },
      { label: 'sky-blue',   hex: '#04b0df', tw: 'bg-sky-blue'   },
      { label: 'light-blue', hex: '#90e0ef', tw: 'bg-light-blue' },
      { label: 'pale-ice',   hex: '#beedf4', tw: 'bg-pale-ice'   },
    ],
  },
  {
      ...
      <div className="flex flex-col gap-6">
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div className="space-y-3">
            ...
            <h2 className="text-4xl font-black uppercase italic tracking-tighter text-title">
          ...
          <div className="flex items-center justify-between gap-4 border-b border-border pb-3 mb-6">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <h3 className="text-lg font-bold text-title leading-tight truncate">{group.name}</h3>
      ...
      <section id="section-semantic" className="scroll-mt-6">
        <div className="flex items-center justify-between border-b border-border pb-3 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-title">Semantic Flat Tokens</h3>
        ...
        <div className="mt-8">
          <h4 className="text-base font-bold text-title mb-4">Layout Semantic (adattivi light/dark)</h4>
      ...
      <section id="section-system" className="scroll-mt-6">
        <div className="flex items-center justify-between border-b border-border pb-3 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-title">System UI</h3>
          ...
          {SYSTEM_TOKENS.map(t => (
            <div key={t.label} onClick={() => copy(t.hex)} className="group cursor-pointer select-none">
              ...
              <div className="mt-2 space-y-0.5">
                ...
                <p className="font-mono text-xs text-desc opacity-60">{t.hex}</p>
                <p className="font-mono text-xs text-desc opacity-30">--{t.label}-ch: {t.ch}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section id="section-opacity" className="scroll-mt-6">
        <div className="flex items-center justify-between border-b border-border pb-3 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-title">Opacity Variants</h3>
