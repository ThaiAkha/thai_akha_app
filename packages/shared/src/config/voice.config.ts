...
const VOICE_PRESETS: Record<string, VoiceConfig> = {
  ...
  young: {
    voiceName: 'Puck',
    accentPrompt: `You are a warm, playful storyteller. Use simple, fun language with lots of wonder and enthusiasm. Keep sentences short and end with a cheerful question.`,
    fallbackTTSPreferences: ['Google th-TH', 'Kanya', 'Narisa'],
  },
  agency_en: {
    voiceName: 'Kore',
...
export function getVoiceConfig(
  ...
  if (role === 'user' && age !== undefined && age <= 18) return VOICE_PRESETS.young;
